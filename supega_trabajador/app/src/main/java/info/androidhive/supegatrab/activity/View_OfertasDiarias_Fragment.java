...
import info.androidhive.supegatrab.adapter.CustomListAdapter;
...
public class View_OfertasDiarias_Fragment extends Fragment {
    ...
    public View_OfertasDiarias_Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ((MainActivity) getActivity()).setActionBarTitle(getString(R.string.title_ofertasdia));
        ...
        JsonArrayRequest movieReq = new JsonArrayRequest(AppConfig.URL_OFERDIA,
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                Fragment fragment = new View_OfertasDiariasView_Fragment();

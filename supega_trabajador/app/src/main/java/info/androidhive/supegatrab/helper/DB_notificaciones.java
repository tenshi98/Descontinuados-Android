package info.androidhive.supegatrab.helper;
...
import info.androidhive.supegatrab.model.Notifications;
...
public class DB_notificaciones extends SQLiteOpenHelper {
	...
	public static final String DATABASE_NAME = "supega_notificaciones";
	/**********************************************************************************************/
	...
	public static final String KEY_JOB        = "idTrabajos";
	public static final String KEY_LAT        = "Latitud";
	public static final String KEY_LONG       = "Longitud";
	public static final String KEY_TYPE       = "idTipoNoti";
	/**********************************************************************************************/
	...
	public Notifications getNoti(int id) {
		...
		Cursor cursor = db.query(TABLE_NOTIFICATIONS, new String[]{KEY_ID,
						KEY_MSG,KEY_TXT,KEY_DATE, KEY_HOUR, KEY_WEB, KEY_TIPO, KEY_ROOM, KEY_JOB, KEY_LAT, KEY_LONG, KEY_TYPE}, KEY_ID + "=?",
	...
	public List<Notifications> getAllNoti() {
		...
		if (cursor.moveToFirst()) {
			do {
				...
				notificacion.setJob(cursor.getString(8));
				notificacion.setLatitud(cursor.getString(9));
				notificacion.setLongitud(cursor.getString(10));
				notificacion.setidtipo(cursor.getString(11));

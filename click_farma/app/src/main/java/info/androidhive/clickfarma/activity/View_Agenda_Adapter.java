...
public class View_Agenda_Adapter extends ArrayAdapter<View_Agenda_Model> {

    private final Context context;
    private final ArrayList<View_Agenda_Model> modelsArrayList;

    public View_Agenda_Adapter(Context context, ArrayList<View_Agenda_Model> modelsArrayList) {

...
public class View_VidaSanaView_Fragment extends Fragment {
    ...
    public View_VidaSanaView_Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ((MainActivity) getActivity()).setActionBarTitle(getString(R.string.title_vidasanadet));
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Fragment fragment = new View_VidaSanaList_Fragment();
    ...
    public void  searchVidaSana(final String idVidaSana) {
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST,
                AppConfig.URL_VIEWVIDASANA, new Response.Listener<String>() {
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("idVidaSana", idVidaSana);

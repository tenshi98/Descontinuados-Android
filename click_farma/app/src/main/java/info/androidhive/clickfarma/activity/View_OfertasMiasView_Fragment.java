...
public class View_OfertasMiasView_Fragment extends Fragment {
   ...
   // private JSONArray dataOferta = null;
    ...
    public View_OfertasMiasView_Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ((MainActivity) getActivity()).setActionBarTitle(getString(R.string.title_ofertasmiadet));
    ...
    public void  searchOferta(final String idOferta) {
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST,
                AppConfig.URL_OFERMIAVIEW, new Response.Listener<String>() {
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("idOfertasMias", idOferta);

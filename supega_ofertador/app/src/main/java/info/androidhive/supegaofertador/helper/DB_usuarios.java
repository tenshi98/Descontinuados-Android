...
public class DB_usuarios extends SQLiteOpenHelper {
	...
	private static final String DATABASE_NAME = "supega2_usuarios";
	/**********************************************************************************************/
	...
	public void addUser(String idCliente, String email, String Nombre, String Rut, String fNacimiento, String Direccion, String Fono1, String Fono2,
						String Departamento, String Provincia, String Distrito, String fcreacion, String factualizacion, String Saldo, String Sexo,
						String Edad, String Profesion) {
		...
		values.put(KEY_PROFESION, Profesion);
	...
	public HashMap<String, String> getUserDetails() {
		...
		if (cursor.getCount() > 0) {
			...
			user.put("Sexo", cursor.getString(17));
			user.put("Edad", cursor.getString(18));
			user.put("Profesion", cursor.getString(19));
	...
	public int updateUser(String idUser,String idCliente, String email, String Nombre, String Rut, String fNacimiento, String Direccion, String Fono1
			,String Fono2,String Departamento, String Provincia, String Distrito, String fcreacion, String factualizacion, String Sexo,
						  String Edad) {
		SQLiteDatabase db = this.getWritableDatabase();

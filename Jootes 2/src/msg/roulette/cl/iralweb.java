...
import static msg.roulette.cl.CommonUtilities.SERVER_URL_DATOS;
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //verifica si el gps esta activo
        ...
        final String regId = GCMRegistrar.getRegistrationId(this);
				    	...
				    	String finalurl = SERVER_URL_DATOS 
				    			+"?id="
				    			+ regId 
				    			+"&msg=" 
							    + String.valueOf(GCMIntentService.mensaje) 
				    			+"&latitud=" 
				    			+ String.valueOf(iralweb.latitude)
							    +"&longitud=" 
							    + String.valueOf(iralweb.longitude)
							    ;

...
import static msg.roulette.cl.CommonUtilities.SERVER_CONVER;
import static msg.roulette.cl.CommonUtilities.SENDER_ID;

public class conversaciones extends Activity  {
    private WebView Conversaciones;
      ...
      //verifica si el gps esta activo
        ...
        try
		{
	        ...
	        final String regId = GCMRegistrar.getRegistrationId(this);
				    	...
				    	Conversaciones = (WebView) findViewById(R.id.webView1);
				    	Conversaciones.getSettings().setJavaScriptEnabled(true);
				    	Conversaciones.addJavascriptInterface(this, "jsNativeInterface");
				    	Conversaciones.loadUrl(finalurl);
				        //evitar que la aplicacion abra ventanas del navegador
				    	Conversaciones.setWebViewClient(new WebViewClient() {
					        @Override

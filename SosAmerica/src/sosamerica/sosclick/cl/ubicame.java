...
import static sosamerica.sosclick.cl.CommonUtilities.DONDE;


@SuppressLint("JavascriptInterface")
public class ubicame extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String paso= String.valueOf(GCMNotificationIntentService.mensaje);
         ...
         if (paso != null && paso != "null" && !paso.equals("")) {
        	...
        	ualerta="Hola, donde te encuentras ahora?";
        }
	    ...
	    String finalurl ="";
    		...
    		dialogo.setTitle("Informar");
    		dialogo.setMessage(ualerta);
    		dialogo.setPositiveButton("Enviar ubicación", new OnClickListener() {

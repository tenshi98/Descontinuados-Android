...
public class View_MySell_Adapter extends ArrayAdapter<View_MySell_Model> {

    private final Context context;
    private final ArrayList<View_MySell_Model> modelsArrayList;

    public View_MySell_Adapter(Context context, ArrayList<View_MySell_Model> modelsArrayList) {

...
import info.androidhive.easypago.gcm.GCMClientManager;
...
public class LoginActivity_back extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (session.isLoggedIn()) {
            ...
            Intent intent = new Intent(LoginActivity_back.this, MainActivity.class);
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (!error) {
                        ...
                        dataUsuarios.addUser(idCliente, email, Nombre, Rut, fNacimiento, Direccion, Fono1, Fono2, Departamento, Provincia, Distrito, fcreacion, factualizacion, Saldo);

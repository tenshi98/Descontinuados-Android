...
import info.androidhive.easypago.app.ServiceLocation;
import info.androidhive.easypago.helper.DB_alertas;
import info.androidhive.easypago.helper.DB_contactos;
import info.androidhive.easypago.helper.DB_eventos;
...
import info.androidhive.easypago.helper.DB_notificaciones;
...
import info.androidhive.easypago.model.Eventos;
...
public class MainActivity extends AppCompatActivity implements FragmentDrawer.FragmentDrawerListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		dataVentas           = new DB_ventas(getApplicationContext());
	...
	private void displayView(int position) {
		...
		switch (position) {
			...
			case 1: fragment = new View_Tutorial_Fragment();           break;
			case 2: fragment = new View_Perfil_Fragment();             break;
			case 3: fragment = new View_MySell_Fragment();             break;
			case 4: fragment = new View_Notifications_Fragment();      break;
	...
	public void logoutUser() {
		...
		//elimino todas las ventas
		dataVentas.deleteAllVenta();
	...
	/**********************************************************************************************/
	/*                          Modulo para la creacion de una Venta                              */
	/**********************************************************************************************/
	//Se crea una alarma
	public void  addVenta(final String idVendedor, final String idCliente, final String Monto, final String Fono, final String NuevoSaldo ) {
		...
		try {
			StringRequest strReq = new StringRequest(Request.Method.POST,
					AppConfig.URL_DATOS_PAGO, new Response.Listener<String>() {
				...
				protected Map<String, String> getParams() {
					// Posting parameters to login url
					Map<String, String> params = new HashMap<String, String>();
					params.put("idVendedor", idVendedor);
					params.put("idCliente", idCliente);
	...
	public void delVentas() {
		...
		//refresco la pantalla
		Fragment fragment = null;
		fragment = new View_MySell_Fragment();

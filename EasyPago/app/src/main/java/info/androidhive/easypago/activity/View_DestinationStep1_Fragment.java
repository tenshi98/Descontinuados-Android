...
public class View_DestinationStep1_Fragment extends Fragment {
    ...
    public View_DestinationStep1_Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_destination_step1, container, false);
        ...
        btnSiguiente       = (Button) rootView.findViewById(R.id.btnSig);
        ...
        btnSiguiente.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!int_direccion.isEmpty() ) {
                    ...
                    String Destino = int_direccion;
                    if (!int_distrito.isEmpty() ) {Destino += ","+int_distrito;}
                    if (!int_provincia.isEmpty() ) {Destino += ","+int_provincia;}
                    if (!int_departamento.isEmpty() ) {Destino += ","+int_departamento;}
                    Destino.concat(",Peru");
                    ...
                    Fragment fragment = new View_DestinationStep2_Fragment();
